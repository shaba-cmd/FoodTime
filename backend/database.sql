-- FoodTime Database Schema
CREATE DATABASE IF NOT EXISTS foodtime CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE foodtime;
...
-- Insert admin user (password: FTAdmin333, hashed)
...
-- Insert FAQ items (используем двойные кавычки для обёртки, одинарные внутри текста)
